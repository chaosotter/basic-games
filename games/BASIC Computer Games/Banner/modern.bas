5 CLS: COLOR 12
6 PRINT TAB(37); "Banner"
7 PRINT TAB(31); "Creative Computing"
8 PRINT TAB(29); "Morristown, New Jersey"
9 PRINT: PRINT: PRINT
10 COLOR 10: INPUT "Horizontal scale"; X
20 INPUT "Vertical scale"; Y
21 INPUT "Centered (Y/N)"; L$
22 G1 = 0: IF LEFT$(L$, 1) = "Y" OR LEFT$(L$, 1) = "y" THEN G1 = 1
23 INPUT "Character ('ALL' if you want the character being printed)"; M$
25 IF M$ = "" THEN M$ = CHR$(178)
29 PRINT "Statement";
30 INPUT A$: COLOR 15
35 PRINT: PRINT "Okay, here goes.  The program will pause after each letter.": PRINT
40 A = ASC(LEFT$(A$, 1))
50 REM
60 REM
70 FOR T = 1 TO LEN(A$)
75 Z$ = INKEY$: IF Z$ = "" THEN 75
80 P$ = MID$(A$, T, 1)
85 IF P$ >= "a" AND P$ <= "z" THEN P$ = CHR$(ASC(P$) - 32)
90 FOR O = 1 TO 50
...
200 RESTORE
201 X$ = M$
202 IF M$ = "ALL" OR M$ = "all" THEN X$ = S$
205 FOR U = 1 TO 7
...
630 NEXT T1
700 NEXT U
750 FOR H = 1 TO X: PRINT: NEXT H
800 NEXT T
810 END
812 FOR H = 1 TO 3 * X: PRINT: NEXT H
813 GOTO 800
