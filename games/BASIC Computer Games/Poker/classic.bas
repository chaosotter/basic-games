...
320 PRINT
330 IF I <> 6 THEN 470
340 IF RND(1) <= .7 THEN 370
350 LET X = 11100
360 GOTO 420
370 IF RND(1) <= .7 THEN 400
380 LET X = 11110
390 GOTO 420
400 IF RND(1) >= .1 THEN 450
410 X = 11111
420 I = 7
430 Z = 23
440 GOTO 580
...
550 Z = 2
560 IF RND(1) >= .1 THEN 580
570 Z = 35
580 V = Z + INT(RND(1) * 10)
590 GOSUB 3480
...
1230 Z = 2
1240 IF INT(RND(1) * 10) <> 6 THEN 1260
1250 Z = 19
1260 GOTO 1330
1270 IF U >= 16 THEN 1320
1280 Z = 19
1290 IF INT(RND(1) * 10) <> 8 THEN 1310
1300 Z = 11
1310 GOTO 1330
1320 Z = 2
1330 K = 0
...
1690 GOTO 140
1700 IF M - 100 * INT(M / 100) > D - 100 * INT(D / 100) THEN 670
