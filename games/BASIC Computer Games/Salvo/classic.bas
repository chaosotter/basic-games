...
1020 PRINT: PRINT: PRINT: RANDOMIZE TIMER
1030 REM
...
1300 KI = K: GOSUB 6000: IF Y + V * KO > 10 THEN 1260
1310 KI = K: GOSUB 6000: IF Y + V * KO < 1 THEN 1260
1320 KI = K: GOSUB 6000: IF X + V2 * KO > 10 THEN 1260
1330 KI = K: GOSUB 6000: IF X + V2 * KO < 1 THEN 1260
1340 U6 = U6 + 1
1350 IF U6 > 25 THEN 1190
1360 KI = K: GOSUB 6000: ZZ = KO: FOR Z = 0 TO ZZ
1370 KI = K: GOSUB 5000: F(Z + KO) = X + V2 * Z
1380 KI = K: GOSUB 5000: G(Z + KO) = Y + V * Z
1390 NEXT Z
1400 KI = K: GOSUB 5000: U8 = KO
1405 KI = K: GOSUB 6000: IF U8 > U8 + KO THEN 1460
1410 KI = K: GOSUB 6000: ZZ = KO: FOR Z2 = U8 TO U8 + ZZ
1415 IF U8 < 2 THEN 1450
1420 FOR Z3 = 1 TO U8 - 1
1430 IF SQR((F(Z3) - F(Z2)) ^ 2 + (G(Z3) - G(Z2)) ^ 2) < 3.59 THEN 1260
1440 NEXT Z3
1450 NEXT Z2
1460 KI = K: GOSUB 6000: ZZ = KO: FOR Z = 0 TO ZZ
...
4230 GOTO 3380
4240 END
5000 KO = (5 - KI) * 3 - 2 * INT(KI / 4) + SGN(KI - 1) - 1: RETURN
6000 KO = KI + INT(KI / 4) - SGN(KI - 1): RETURN
