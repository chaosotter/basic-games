...
475 'DEF FNR(R)=INT(RND(1)*7.98+1.01)
480 REM INITIALIZE ENTERPRIZE'S POSITION
490 Q1 = INT(RND(1) * 7.98 + 1.01): Q2 = INT(RND(1) * 7.98 + 1.01): S1 = INT(RND(1) * 7.98 + 1.01): S2 = INT(RND(1) * 7.98 + 1.01)
...
1040 G(I, J) = K3 * 100 + B3 * 10 + INT(RND(1) * 7.98 + 1.01): NEXT J: NEXT I: IF K9 > T9 THEN T9 = K9 + 1
1100 IF B9 <> 0 THEN 1200
1150 IF G(Q1, Q2) < 200 THEN G(Q1, Q2) = G(Q1, Q2) + 120: K9 = K9 + 1
1160 B9 = 1: G(Q1, Q2) = G(Q1, Q2) + 10: Q1 = INT(RND(1) * 7.98 + 1.01): Q2 = INT(RND(1) * 7.98 + 1.01)
...
6060 H = INT((K(I, 3) / (SQR((K(I, 1) - S1) ^ 2 + (K(I, 2) - S2) ^ 2))) * (2 + RND(1))): S = S - H: K(I, 3) = K(I, 3) / (3 + RND(0))
...
10000 REM
10010 REM INSTRUCTIONS FOR "SUPER STARTREK"  MAR 5, 1978
10020 FOR I = 1 TO 12: PRINT: NEXT I
10021 PRINT TAB(10); "*************************************"
10022 PRINT TAB(10); "*                                   *"
10023 PRINT TAB(10); "*                                   *"
10030 PRINT TAB(10); "*      * * SUPER STAR TREK * *      *"
10031 PRINT TAB(10); "*                                   *"
10032 PRINT TAB(10); "*                                   *"
10035 PRINT TAB(10); "*************************************"
10036 FOR I = 1 TO 8: PRINT: NEXT I
10040 INPUT "DO YOU NEED INSTRUCTIONS (Y/N)"; K$: IF K$ = "N" THEN 12000
10044 PRINT
10045 REM PRINT "TURN THE TTY ON-LINE AND HIT ANY KEY EXCEPT RETURN"
10046 REM IF INP(1)=13 THEN 10046
10050 REM POKE 1229,2:POKE 1237,3:NULL 1
...
10170 PRINT "     TYPE IN ILLEGAL DATA (LIKE NEGATIVE NUMBERS), THAN COMMAND"
...
10310 PRINT "GALAXY TO BEGIN A TOUR OF DUTY AS COMANDER OF THE STARSHIP"
10320 PRINT "\ENTERPRISE\; YOUR MISSION: TO SEEK AND DESTROY THE FLEET OF"
10330 PRINT "KLINGON WARWHIPS WHICH ARE MENACING THE UNITED FEDERATION OF"
10340 PRINT "PLANETS."
10360 PRINT
...
10500 PRINT "     ONE QUADTANT.  THEREFORE, TO GET"
...
10670 PRINT "     THE SCAN IS CODED IN THE FORM \###\, WHERE TH UNITS DIGIT"
10680 PRINT "     IS THE NUMBER OF STARS, THE TENS DIGIT IS THE NUMBER OF"
10690 PRINT "     STARBASES, AND THE HUNDRESDS DIGIT IS THE NUMBER OF"
...
10750 PRINT "     DEPLETE THEIR SHIELD POWER.  (REMBER, KLINGONS HAVE"
...
10830 PRINT
10835 PRINT "     THE LIBRARY-COMPUTER (\COM\ COMMAND) HAS AN OPTION TO "
10840 PRINT "     COMPUTE TORPEDO TRAJECTORY FOR YOU (OPTION 2)"
10850 PRINT
...
10890 PRINT "     THAN THE STATUS DISPLAY TOTAL ENERGY INCLUDES SHIELD ENERGY"
10900 PRINT
10910 PRINT "\DAM\ COMMAND = DAMMAGE CONTROL REPORT"
10920 PRINT "     GIVES THE STATE OF REPAIR OF ALL DEVICES.  WHERE A NEGATIVE"
...
10990 PRINT "        THIS OPTION SHOWES COMPUTER MEMORY OF THE RESULTS OF ALL"
...
11030 PRINT "        AND STARBASES REMAINING IN THE GAME."
...
11160 PRINT: INPUT Z$
11990 REM POKE 1229,0:POKE 1237,1:NULL 0
12000 REM PRINT:PRINT:PRINT
12010 REM PRINT "TURN CASSETTE PLAYER ON AND HIT ANY KEY EXCEPT RETURN"
12020 REM IF INP(1)=13 THEN 2020
12030 REM PRINT
12040 REM PRINT "TURN CASSETTE PLAYER OFF AND "
12050 REM PRINT "TYPE 'RUN' WHEN COMPUTER PRINTS 'OK'"
12060 RETURN
