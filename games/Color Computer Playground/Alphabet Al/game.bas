...
40 REM *** ALPHABET AL
50 CLS
65 PRINT@35,"***  ALPHABET AL  ***"
67 FOR PAUSE=1 TO 1000:NEXT PAUSE
70 FOR X=65 TO 90
100 CLS
120 FOR I=1 TO 25
130 PRINT@ RND(500), CHR$(X);
140 SOUND RND(200),2
150 NEXT I 
152 FOR PAUSE=1 TO 200: NEXT PAUSE:CLS
153 PRINT@227,"WHAT LETTER DID AL PLANT";:INPUT A$
154 IF A$=CHR$(X) THEN GOSUB 1010:GOTO 160 
