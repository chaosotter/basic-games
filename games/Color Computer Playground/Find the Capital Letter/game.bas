...
62 CLS
65 PRINT@34,"***  FIND THAT LETTER!  ***"
66 FOR PAUSE=1 TO 1000:NEXT PAUSE
70 MAX=750
100 PRINT@236," "
120 FOR ALPHA=65 TO 90
125 COUNT=0
126 PRINT@239,CHR$(ALPHA)
128 COUNT=COUNT+1:IF COUNT=MAX THEN 160
130 CHILD$=INKEY$:IF CHILD$="" THEN 128
150 IF ASC(CHILD$)=ALPHA THEN GOSUB 1010:GOTO 170
160 GOSUB 2010:PRINT@239," ":GOTO 125
170 NEXT ALPHA
171 IF MAX<=50 THEN 180
172 PRINT@236,"FASTER";:INPUT A$
173 IF LEFT$(A$,1)<>"Y" THEN 177
175 MAX=MAX-100:GOTO 100
