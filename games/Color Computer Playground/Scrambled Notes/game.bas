...
210 GOSUB 2010:GOSUB 3510:SOUND MUSIC(N),24
230 J=J+1:IF J<9 THEN 142
235 GOTO 140
240 IF O<10 THEN GOSUB 3510
245 NEXT O
260 CLS:PRINT@461,"AGAIN";:INPUT A$
270 IF LEFT$(A$,1)="Y" THEN GOTO 100
280 IF LEFT$(A$,1)<>"N" THEN 260
290 CLS:END
1000 REM ***HAPPY FACE***
1010 FOR A=0 TO 2
...
3510 CLS 2
3512 PRINT@132,"***   WHICH NOTE?   ***";
3520 RETURN
4000 REM *** PLAY NOTES
4010 CLS 2
4012 PRINT@34,"***  LISTEN TO THE NOTES  ***";
4015 FOR J=FIRST TO LAST STEP HOP
4040 PRINT@238,"    ";
4050 IF J<> 8 THEN 4080
4060 PRINT@238,"HI-";CHR$(KEY(J));
4070 GOTO 4090
4080 PRINT@239,CHR$(KEY(J));
4090 SOUND MUSIC(J),16
4092 FOR PAUSE=1 TO 400:NEXT PAUSE
4100 NEXT J
4110 RETURN
