...
1165 IF D1 < Q ^ 32 THEN 1230
1170 IF D1 < 2 * Q ^ 2 THEN PRINT "EXCELLENT BUT COULD BE BETTER:": GOTO 1230
1180 IF D1 < 3 * Q ^ 2 THEN PRINT "GOOD BUT NEEDS SOME INPROVMENT": GOTO 1230
...
1760 PRINT
1765 RETURN
1770 PRINT "IN THIS GAME YOU ROLL "; Q - 1; "BALLS SUCCESSIELY AT A TARG";
1775 PRINT "ET"
...
1830 PRINT "THE BALL CURVE CLOCKWISE. A NEGITIVE ANGLE WILL MAKE IT CURVE"
...
1870 PRINT: PRINT "HINT. TRY AN INITIAL VELOCMTY OF 500 AND AN ANGLE OF 10"
