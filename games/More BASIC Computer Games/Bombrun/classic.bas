...
110 PRINT "THESE PASSES.  ALTITUDE CHANGES MAYBE MADE THROUGH THE"
...
160 PRINT "ANGELS, VARYING FROM 0 TO 15 DEGREES, WILL ADD AS SPEC-"
...
270 PRINT "POSITIONING INFORMATION UPON THE COOMAND 'STAND BY'.  THE"
...
890 PRINT "YOUR BOMBER CANNOT TOLERATE THE STRSS CAUSED BY ANGLE"
...
1100 PRINT " ENGINE TO FAIL AND YOUR PLANE TO CRASH.  RECONSIDER YOUR "
1105 PRINT "CHOICE"
1110 PRINT " "
1120 GOTO 670
1130 A1 = 0
...
1620 PRINT TAB(16); "PRESENT VEROCITY... "; V; "FEET PER SECOND"
...
1700 PRINT "TINE TO EXPLOSION... "; T3; "SECONDS"
1710 X = X - V * COS(B) * T3
...
2130 PRINT "MAXIMUM ANGLE INPUT OF 15 DEGEES. NEXT TIME TAKE MY ADVISE"
2150 H = 1
2160 GOTO 1920
...
2230 H = 1
2240 GOTO 1920
2250 PRINT "THE VEROCITY OF YOUR BOMBER WAS INSUFFICIENT TO SUPPORT"
2260 PRINT "ITS WEIGHT, AND CONSEQUENTLY IT CRASHED."
2270 H = 1
2280 GOTO 1920
2290 PRINT "YOUR BOMBER FAILED TO MAINTAIN THE LOW ALTUTUTE YOU DE-"
...
2350 PRINT "SAY, YOU NO LONGER THREATHEN ITS EXISTANCE."
2360 PRINT " "
