...
170 COLOR 10: INPUT "Do you want instructions (Y/N)"; A$: COLOR 15
180 IF LEFT$(A$, 1) = "N" OR LEFT$(A$, 1) = "n" THEN 270
190 IF LEFT$(A$, 1) = "Y" OR LEFT$(A$, 1) = "y" THEN 210
200 PRINT "Yes or no.": GOTO 170
210 COLOR 14: PRINT
215 PRINT "The game consists of stacking X's and O's (the computer has O) until one of"
220 PRINT "the players gets four in a row vertically, horizontally, or diagonally."
260 PRINT: PRINT: COLOR 15
270 X$ = "X": O$ = "O"
280 FOR I = 1 TO 8: FOR J = 1 TO 8: B$(I, J) = "-": NEXT J: NEXT I
290 FOR Z1 = 1 TO 8: L(Z1) = 0: NEXT Z1
300 COLOR 10: INPUT "Do you want to go first (Y/N)"; A$
310 IF LEFT$(A$, 1) = "N" OR LEFT$(A$, 1) = "n" THEN 610
320 GOSUB 340
330 GOTO 450
340 COLOR 11: PRINT: FOR I = 8 TO 1 STEP -1
350 FOR J = 1 TO 8
360 PRINT "  "; B$(I, J);
370 NEXT J
380 PRINT
...
420 PRINT: PRINT: COLOR 15
430 RETURN
440 PRINT "Illegal move, try again."
450 COLOR 10: INPUT "A number between 1 and 8"; M
460 M = INT(M)
