10 RANDOMIZE TIMER
20 CLS: COLOR 12
100 PRINT TAB(36); "Inkblot"
105 PRINT TAB(31); "Creative Computing"
110 PRINT TAB(29); "Morristown, New Jersey"
115 PRINT: PRINT: PRINT: COLOR 15
...
540 IF R < 0 THEN 690
550 R = SQR(R)
560 REM *** FIND WHERE THE LINE INTERSECTS THE ELLIPSE
...
670 A$ = LEFT$(A$, J - 1) + CHR$(178) + RIGHT$(A$, LEN(A$) - J)
680 NEXT J
690 NEXT E
700 REM *** PRINT LINE
710 PRINT A$;
...
730 PRINT MID$(A$, K, 1);
740 NEXT K
745 N = N + 1: IF N < 22 THEN 750 ELSE N = 0
746 Z$ = INKEY$: IF Z$ = "" THEN 746
750 NEXT Y
