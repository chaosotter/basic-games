...
120 COLOR 10: PRINT "Do you need instructions (Y/N)";: INPUT A$: COLOR 15
130 IF LEFT$(A$, 1) = "Y" OR LEFT$(A$, 1) = "y" THEN 150
140 GOTO 200
150 PRINT: PRINT: COLOR 14
155 PRINT "This program will simulate a near-sighted mouse in a maze.  You select the"
160 PRINT "difficulty factor -- size!  You may have a maze of any size permitted by the"
170 PRINT "size of your system.  Dimensions less than 5 are too trivial.  Each maze is"
...
1530 V(R, S) = V(R, S) + 1
1540 GOSUB 2320
1550 COLOR 10: PRINT "Do you want the solution (Y/N)";: INPUT A$: COLOR 15
1560 IF LEFT$(A$, 1) <> "Y" AND LEFT$(A$, 1) <> "y" THEN 2620
1570 COLOR 10: PRINT "Do you want to see each step (Y/N)";: INPUT A$: PRINT: PRINT: COLOR 15
...
1950 IF Y = V AND X = E THEN PRINT: GOSUB 2250: GOTO 2620
1960 GOSUB 2230
...
2220 GOTO 1950
2230 IF LEFT$(A$, 1) <> "Y" AND LEFT$(A$, 1) <> "y" THEN RETURN
2240 PRINT
2250 FOR I = 1 TO H
2260 IF I = S THEN 2290
2270 PRINT STRING$(3, 178);
2280 GOTO 2300
2290 PRINT CHR$(178);: COLOR 13: PRINT STRING$(2, 176);: COLOR 15
2300 NEXT I
2310 PRINT CHR$(178)
2320 FOR J = 1 TO V
2330 PRINT CHR$(178);
...
2380 IF Z <> V(I, J) AND V(I + 1, J) > 3 THEN COLOR 13: PRINT STRING$(3, 176);: COLOR 15: GOTO 2440
2390 IF Z <> V(I, J) THEN COLOR 13: PRINT STRING$(2, 176);: COLOR 15: PRINT " ";: GOTO 2440
2400 PRINT "   ";
2410 GOTO 2440
2420 IF Z <> V(I, J) THEN COLOR 13: PRINT STRING$(2, 176);: COLOR 15: PRINT CHR$(178);: GOTO 2440
2430 PRINT "  "; CHR$(178);
2440 NEXT I
2450 PRINT
2460 FOR I = 1 TO H
...
2510 IF Z <> V(I, J) AND J = V THEN PRINT CHR$(178);: COLOR 13: PRINT STRING$(2, 176);: COLOR 15: GOTO 2570
2520 IF J = V THEN 2540
2530 IF Z <> V(I, J) AND V(I, J + 1) > 3 THEN PRINT CHR$(178);: COLOR 13: PRINT STRING$(2, 176);: COLOR 15: GOTO 2570
2540 PRINT CHR$(178); "  ";
2550 GOTO 2570
2560 PRINT STRING$(3, 178);
2570 NEXT I
2580 PRINT CHR$(178)
2590 NEXT J
2600 PRINT
2610 RETURN
2620 COLOR 10: PRINT "Do you want another maze (Y/N)";: INPUT A$: COLOR 15
2630 IF LEFT$(A$, 1) = "Y" OR LEFT$(A$, 1) = "y" THEN PRINT: GOTO 210
2640 PRINT: END
