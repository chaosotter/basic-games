...
1290 GOTO 2510
1300 PRINT "YAAAAAAAAAAAAAAH TRAPDOOR, YOU FELL DOWN ONE LEEL"
1310 L2 = L2 - 1
...
1670 PRINT
1672 PRINT STRING$(31, ASC("*"));
1680 PRINT TAB(32); "MINOTAUR";
1681 PRINT TAB(41); STRING$(31, ASC("*"));
1720 PRINT
1730 PRINT
...
1820 PRINT
1825 PRINT STRING$(31, ASC("*"));
1830 PRINT TAB(33); "CAVERN";
1832 PRINT TAB(41); STRING$(31, ASC("*"));
1836 PRINT
1837 PRINT
...
1890 PRINT: INPUT Z$
1910 PRINT STRING$(31, ASC("*"));
1940 PRINT TAB(32); "HAZARDS";
1945 PRINT TAB(41); STRING$(31, ASC("*"));
1950 PRINT
1955 PRINT
...
2280 PRINT TAB(41); STRING$(30, ASC("*"));
2310 PRINT
2320 RETURN
2330 REM BARRIERS
