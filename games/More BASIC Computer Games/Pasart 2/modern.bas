...
110 DIM P(72, 72)
130 PRINT "This program creates artistic designs based on Pascal's Triangle."
140 COLOR 10: PRINT "Do you want a list of options (Y/N)";
150 INPUT S1$: COLOR 15
170 IF LEFT$(S1$, 1) <> "Y" AND LEFT$(S1$, 1) <> "y" THEN 630
175 PRINT: COLOR 14
180 PRINT "Please tear off this list and save or post for future reference."
190 PRINT "----------------------------------------------------------------"
195 PRINT
200 COLOR 11: PRINT "1. A single Pascal's Triangle played back like this:": PRINT
210 COLOR 14: PRINT "         Before Printing     After Printing"
220 COLOR 12: PRINT "              1 1 1              ***"
230 PRINT "              1 2 3              * *"
240 PRINT "              1 3 6              **": PRINT
250 COLOR 11: PRINT "2. A single Pascal's Triangle played back like this:": PRINT
260 COLOR 14: PRINT "         Before Printing     After Printing"
270 COLOR 12: PRINT "                1                 *"
280 PRINT "                1 1               **"
290 PRINT "                1 2 1             * *": PRINT
295 COLOR 13: PRINT "(Press any key.)"
296 Z$ = INKEY$: IF Z$ = "" THEN 296
300 COLOR 11: PRINT: PRINT "3. A single Pascal's Triangle played back like this:": PRINT
310 COLOR 14: PRINT "         Before Printing     After Printing"
320 COLOR 12: PRINT "                1                  *"
330 PRINT "              1 2 1              *   *"
340 PRINT "             1 3 3 1            * * * *": PRINT
350 COLOR 11: PRINT "4. Two Pascal's Triangles printed back-to-back like this:": PRINT
360 COLOR 14: PRINT "         Before Printing     After Printing"
370 COLOR 12: PRINT "             1 1 1 0             ***"
380 PRINT "             1 2 0 1             *  *"
390 PRINT "             1 0 2 1             *  *"
400 PRINT "             0 1 1 1              ***": PRINT
405 COLOR 13: PRINT "(Press any key.)"
406 Z$ = INKEY$: IF Z$ = "" THEN 406
410 COLOR 11: PRINT: PRINT "5. Four Pascal's Triangles printed in a square like this:": PRINT
420 COLOR 14: PRINT "         Before Printing     After Printing"
430 COLOR 12: PRINT "            1 1 1 1 1 1        ******"
440 PRINT "            1 2     2 1        *    *"
450 PRINT "            1         1        *    *"
460 PRINT "            1         1        *    *"
470 PRINT "            1 2     2 1        *    *"
480 PRINT "            1 1 1 1 1 1        ******": PRINT
490 COLOR 11: PRINT "6. Four Pascal's Triangles printed in a square like this:": PRINT
500 COLOR 14: PRINT "         Before Printing     After Printing"
510 COLOR 12: PRINT "            1 1 1 1 1 1        ******"
520 PRINT "            1 2 3 3 2 1        * ** *"
530 PRINT "            1 3 6 6 3 1        **  **"
540 PRINT "            1 3 6 6 3 1        **  **"
550 PRINT "            1 2 3 3 2 1        * ** *"
560 PRINT "            1 1 1 1 1 1        ******": PRINT
565 COLOR 13: PRINT "(Press any key.)"
566 Z$ = INKEY$: IF Z$ = "" THEN 566
570 COLOR 11: PRINT: PRINT "7. Starting Pascal's Triangle in any desired row & column so that a user can"
580 PRINT "   tape together several pictures to make a larger design.  This option extends"
590 PRINT "   pictures like thoser shown in option 1 in 36x36-character chunks.  Entries"
600 PRINT "   up to 1000 rows and columns are accepted."
610 PRINT: COLOR 14
620 PRINT "----------------------------------------------------------------"
625 PRINT
630 COLOR 10: PRINT "What's your pleasure (1-7)";
640 INPUT O: COLOR 15
650 IF O <= 7 AND O >= 1 THEN 660
655 PRINT "I'm supposed to be your friend, so how about it?": GOTO 630
660 COLOR 10: PRINT "Your picture should highlight the multiples of what number";
670 INPUT Q: COLOR 15
680 COLOR 10: PRINT "What character would you like the computer to type representing the multiples"
690 PRINT "  of"; Q; "(enter ' ' for a blank)";
700 INPUT S$: COLOR 15
710 COLOR 10: PRINT "What character would you like the computer to type representing each of the"
720 PRINT "  other numbers in the pattern (enter ' ' for a blank)";
730 INPUT T$: COLOR 15
740 IF O = 7 THEN 780
750 COLOR 10: PRINT "How many rows and columns in the array (36 is max.)";
760 INPUT T: COLOR 15
770 IF T > 36 THEN PRINT "Be reasonable!": GOTO 750
780 COLOR 10: PRINT "Would you like a calendar printed with your picture (Y/N)";
800 INPUT R5$: COLOR 15
810 IF LEFT$(R5$, 1) <> "Y" AND LEFT$(R5$, 1) <> "y" THEN 850
820 COLOR 10: PRINT "What year between 1600 and 2300 would you like";
830 INPUT Y9: COLOR 15
...
1150 PRINT
1160 NEXT R
1170 IF LEFT$(R5$, 1) = "Y" OR LEFT$(R5$, 1) = "y" THEN 3260
1180 GOTO 3710
...
3430 FOR R = 1 TO 12
3440 READ A$
3445 Z$ = INKEY$: IF Z$ = "" THEN 3445
3450 PRINT TAB(21); A$; X
3460 READ B
3470 IF X / 4 <> INT(X / 4) THEN 3500
3480 IF A$ <> "FEBRUARY" THEN 3500
3490 LET B = B + 1
3500 REM TIME TO PRINT THE CALENDAR FOR THE YEAR X
3510 PRINT "    "; STRING$(41, 205)
3520 PRINT "     SUN   MON   TUE   WED   THU   FRI   SAT "
3530 PRINT "    "; STRING$(41, 196)
3540 FOR D = 1 TO B
3550 COLOR 11: PRINT TAB(4 + 6 * C + 1); D;
3560 LET C = C + 1
3570 IF C < 7 THEN 3600
3580 PRINT
3590 C = 0
3600 NEXT D: COLOR 15
3610 PRINT
3620 PRINT "    "; STRING$(41, 205)
3640 PRINT: PRINT
3660 NEXT R
