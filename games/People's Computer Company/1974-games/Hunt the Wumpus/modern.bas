...
15 CLS: COLOR 15
20 COLOR 10: PRINT "Instructions (Y/N)";
30 INPUT I$
40 IF LEFT$(I$, 1) = "N" OR LEFT$(I$, 1) = "n" THEN 52
50 GOSUB 1000
52 REM- ANNOUNCE WUMPUSII FOR ALL AFICIONADOS ... ADDED BY DAVE
54 PRINT: COLOR 12
56 PRINT "Attention all Wumpus lovers!!!"
58 PRINT "There are now 3 additions to the Wumpus family of programs."
62 PRINT
64 PRINT "     WUMP2:  Some different cave arrangements."
66 PRINT "     WUMP3:  Different hazards."
67 PRINT "     WUMP4:  Hide 'n' Seek.": PRINT: COLOR 15
...
610 IF LEFT$(I$, 1) <> "Y" AND LEFT$(I$, 1) <> "y" THEN 240
620 GOTO 360
