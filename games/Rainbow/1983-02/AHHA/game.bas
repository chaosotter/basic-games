...
0 'AHHA**ANOTHER HAUNTED HOUSE ADVENTURE
1 'GEOFF WELLS
2 '21-12 EAST AVE N.
3 'HAMILTON-ONTARIO
4 'CANADA-L8L 5H2
...
90 X=1:Y=6
100 GOSUB4000:D$=MID$(MC$(X,Y),1,6):L1=VAL(MID$(MC$(X,Y),7,2)):L2=VAL(MID$(MC$(X,Y),9,2)):L3=VAL(MID$(MC$(X,Y),11,2)):L4=VAL(MID$(MC$(X,Y),13,2))
110 RESTORE:L$=""
120 FORNF=1TO4:READDUMMY$:IFL1=NF THENL$=DUMMY$:NEXTNF ELSENEXTNF
130 FORNF=1TO15:READDUMMY$:IFL2=NF THENL$=L$+DUMMY$:NEXTNF ELSENEXTNF
140 FORNF=1TO18:READDUMMY$:IFL3=NF THENL$=L$+DUMMY$:NEXTNF ELSENEXTNF
150 FORNF=1TO23:READDUMMY$:IFL4=NF THENL$=L$+DUMMY$:NEXTNF ELSENEXTNF
160 OB$="":FORNF=1TO14:IFOL(NF,0)=X ANDOL(NF,1)=Y THENOB$=OB$+"-"+OD$(NF):NEXTNF ELSENEXTNF:IFOB$=""THENOB$=" NOTHING SPECIAL"
...
210 IFC$="N"THEN601ELSEIFC$="S"THEN602ELSEIFC$="E"THEN603ELSEIFC$="W"THEN604ELSEIFC$="U"THEN605ELSEIFC$="D"THEN606ELSEIFC$="LOOK"THEN160ELSEIFC$="HELP"THEN650ELSEIFC$="SAVE"THEN700ELSEIFC$="LOAD"THEN800ELSEIFLEFT$(C$,2)="GO"THENC$="*GO"
211 IFLEFT$(C$,3)="INV"THEN611ELSEIFC$="SCORE"THEN3600
212 IFG>9THENPRINT"THE GHOST CLAIMS ANOTHER VICTIM":END
220 S=0:SP=0:FORNF=1TOLEN(C$):IFMID$(C$,NF,1)=" "THENS=NF:SP=SP+1:NEXTNF ELSENEXTNF
...
260 FC$(0)="*":FORNF=1TO40:IFLEFT$(LC$,3)=FW$(NF)THENFC$(0)=FC$(NF):NEXTNF ELSENEXTNF
270 IFFC$(0)="*"THENPRINT"I DON'T RECOGNIZE THE VERB":GOTO200
280 SC$(0)="*":FORNF=1TO39:IFLEFT$(RC$,3)=SW$(NF)THENSC$(0)=SC$(NF):NEXTNF ELSENEXTNF
300 IFSC$(0)="*"THENP$="I DON'T KNOW WHAT A "+RC$+" IS":GOSUB500:GOTO200
310 M=0:FORNF=1TOLEN(SC$(0)):IFMID$(SC$(0),NF,1)=FC$(0)THENM=99:NEXTNF ELSENEXTNF
320 IFM=0THENP$="I DON'T KNOW HOW TO "+LC$+" A "+RC$:GOSUB500:GOTO200
330 ONASC(FC$(0))-64GOSUB1000,1100,1200,1300,1400,1500,1600,1700,1800,1900,2000,2100,2200,2300,2400,2500,2600,2700,2800,2900,3000,3100,3200,3300,3400,3500
340 IFR=1THENR=0:GOTO100ELSE200
500 IFLEN(P$)>32THENP1$=LEFT$(P$,32):P2$=RIGHT$(P$,LEN(P$)-32)ELSEIFLEN(P$)=32THENPRINTP$;:RETURNELSEPRINTP$:RETURN
510 IFLEFT$(P2$,1)=" "THENP2$=RIGHT$(P2$,LEN(P2$)-1):PRINTP1$;:P$=P2$:GOTO500
520 IFRIGHT$(P1$,1)=" "ANDLEN(P1$)=32THENPRINTP1$;:P$=P2$:GOTO500ELSEIFRIGHT$(P1$,1)=" "THENPRINTP1$:P$=P2$:GOTO500
530 P2$=RIGHT$(P1$,1)+P2$:P1$=LEFT$(P1$,LEN(P1$)-1):GOTO520
601 IFMID$(D$,1,1)="N"THENY=Y-1:GOTO100ELSE607
602 IFMID$(D$,2,1)="S"THENY=Y+1:GOTO100ELSE607
603 IFMID$(D$,3,1)="E"THENX=X+1:GOTO100ELSE607
604 IFMID$(D$,4,1)="W"THENX=X-1:GOTO100ELSE607
605 IFMID$(D$,5,1)="U"THENY=Y-3:GOTO100ELSE607
606 IFMID$(D$,6,1)="D"THENY=Y+3:GOTO100
607 PRINT"YOU CAN'T GO THAT WAY":GOTO200
611 IN$(0)="":FORNF=1TO4:IFIN$(NF)<>"*"THENFORI=1TO14:IFIN$(NF)=OK$(I)THENIN$(0)=IN$(0)+"-"+OD$(I):NEXTI:NEXTNF ELSENEXTI:NEXTNF ELSENEXTNF
612 IFIN$(0)=""THENIN$(0)="YOU ARE NOT CARRYING ANYTHING"ELSEIN$(0)="YOU ARE CARRYING"+IN$(0)
613 P$=IN$(0):GOSUB500
614 GOTO200
650 IFX=2ANDY=1THENP$="WHAT WAS WRITTEN IN THE BEGINNING MAY BE OF SOME HELP HERE" ELSEP$="I CAN BE OF NO ASSISTANCE HERE"
651 GOSUB500:GOTO200
700 CLS:INPUT"READY TAPE<PLAY & RECORD>ENTER";E$
710 OPEN"O",-1,"GAPADFIL":PRINT#-1,X,Y,SC,F:FORNF=1TO4:PRINT#-1,IN$(NF):NEXTNF:FORZ=1TO3:FORW=1TO6:PRINT#-1,MC$(Z,W):NEXTW,Z:FORNF=1TO14:PRINT#-1,OL(NF,0),OL(NF,1):NEXTNF:CLOSE:GOTO100
800 CLS:INPUT"READY TAPE<PLAY>ENTER";E$
810 OPEN"I",-1,"GAPADFIL":INPUT#-1,X,Y,SC,Y:FORNF=1TO4:INPUT#-1,IN$(NF):NEXTNF:FORZ=1TO3:FORW=1TO6:INPUT#-1,MC$(Z,W):NEXTW,Z:FORNF=1TO14:INPUT#-1,OL(NF,0),OL(NF,1):NEXTNF:CLOSE:GOTO100
1000 IN$(0)="":FORNF=1TO4:IFIN$(NF)=RC$ THENIN$(0)="YOU ALREADY HAVE THE "+RC$:NEXTNF ELSENEXTNF
1001 IFIN$(0)<>""THEN1050
1005 IFRC$="BOOK"THENP$="IT CRUMBLES TO DUST AS YOU TOUCH IT":GOSUB500:OL(3,0)=-1:OL(3,1)=-1:B=-1:RETURN
1010 FORNF=1TO4:IFIN$(NF)="*"THENIN$(0)=STR$(NF):NEXTNF ELSENEXTNF
1020 IFIN$(0)=""THENIN$(0)="YOU CAN'T CARRY ANY MORE":GOTO1050
1030 FORNF=1TO14:IFRC$=OK$(NF)ANDOL(NF,0)=X ANDOL(NF,1)=Y THENIN$(VAL(IN$(0)))=OK$(NF):OL(NF,0)=-1:OL(NF,1)=-1:IN$(0)="":NEXTNF ELSENEXTNF
1035 IFRC$="CHEST"THENMC$(2,1)="******01111223"
1040 IFIN$(0)=""THENR=1ELSEIN$(0)="I DON'T SEE A "+RC$
1050 PRINTIN$(0):RETURN
1100 IN$(0)="":FORNF=1TO4:IFIN$(NF)=RC$ THENIN$(0)="*":IN$(NF)="*":FORCK=1TO14:IFOK$(CK)=RC$ THENOL(CK,0)=X:OL(CK,1)=Y:NEXTCK ELSENEXTCK:NEXTNF ELSENEXTNF
1110 IFIN$(0)=""THENPRINT"YOU ARE NOT CARRING THAT":RETURNELSER=1:RETURN
...
1900 IFRC$="DRESSER"THEN1910ELSEIFRC$="BAG"THEN1920ELSEIFRC$="CHAIR"THEN1930ELSEIFRC$="BUTTON"THEN1940ELSE3700
1910 IFX=1ANDY=2THEN1911ELSEPRINT"I DON'T SEE A DRESSER":RETURN
1911 MID$(MC$(1,2),1,1)="N":MID$(MC$(1,2),13,2)="03":R=1:RETURN
1920 IFX=1ANDY=1THEN1921ELSEPRINT"I DON'T SEE ANY BAGS HERE":RETURN
1921 MID$(MC$(1,1),3,1)="E":MID$(MC$(1,1),11,4)="1822":R=1:RETURN
1930 IFX=3ANDY=6THEN1931ELSEPRINT"I'D BE GLAD TO IF IT WAS HERE":RETURN
1931 MID$(MC$(3,6),11,2)="17":OL(14,0)=3:OL(14,1)=6:R=1:RETURN
1940 IFX=3ANDY=2THENNEWELSEPRINT"WHAT BUTTON":RETURN
2000 GOTO3700:'CLIMB
2100 GOTO3700:'PLAY
