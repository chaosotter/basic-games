...
280 IF F > 10 THEN COLOR 10: INPUT "Enter your choice (2-4, 6-8, 10-12)"; X: COLOR 15
...
430 FOR Y = 0 TO 3: PRINT TAB(35);
435 FOR X = 1 TO 4
440 B = B(Y * 4 + X): COLOR 10 + B
450 PRINT B; " ";
460 NEXT X: PRINT: PRINT: NEXT Y: COLOR 15
470 PRINT: PRINT
480 IF F < 10 THEN PRINT: COLOR 12: PRINT "Twist number"; F: COLOR 15
490 IF F > 10 THEN PRINT: COLOR 12: PRINT "Your cubist twist number"; F - 10: PRINT: COLOR 15
