...
90 PRINT "Fastermind"
100 PRINT
110 PRINT "When you are told to do"
120 PRINT "so, enter a 4-digit number"
130 PRINT "and then press RETURN."
140 PRINT
150 PRINT "Digits can be repeated."
160 PRINT
170 PRINT "You have 8 goes to break"
180 PRINT "the difficult code."
190 XX = 2.0: GOSUB 1000
200 CLS
210 DIM B(4)
220 DIM D(4)
230 LET H = 0
...
270 FOR C = 1 TO 8
280 PRINT
290 PRINT "Enter guess number"; C;
300 INPUT X
...
660 PRINT "The answer is: "; B(1); B(2); B(3); B(4)
670 END
680 PRINT: PRINT: PRINT "Well done, Master brain!"
690 PRINT
700 PRINT: PRINT "You got the answer in"
710 PRINT TAB(5); "just"; C; "goes"
720 END
1000 ST = TIMER + XX
