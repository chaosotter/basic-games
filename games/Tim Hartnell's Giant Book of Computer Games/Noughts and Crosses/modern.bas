...
30 CLS
40 N = 0
50 COLOR 13: PRINT "(Press any key when you're ready to play.)": COLOR 15
...
660 GOTO 110
670 REM Player move
680 PRINT: PRINT: COLOR 10: PRINT TAB(28); "Enter your move (1-9)": COLOR 15
690 A$ = INKEY$
...
780 COLOR 13: PRINT TAB(30); "1  2  3   ";: COLOR 15
790 FLAG = 0
800 FOR B = 1 TO 9
810 IF A(B) = 0 THEN FLAG = 1
820 IF A(B) = 0 THEN PRINT " - ";
830 IF A(B) = 1 THEN COLOR 12: PRINT " O ";: COLOR 15
840 IF A(B) = 2 THEN COLOR 11: PRINT " X ";: COLOR 15
850 IF B = 3 THEN PRINT: PRINT: COLOR 13: PRINT TAB(30); "4  5  6   ";: COLOR 15
860 IF B = 6 THEN PRINT: PRINT: COLOR 13: PRINT TAB(30); "7  8  9   ";: COLOR 15
870 NEXT B
880 PRINT: PRINT
